...
import CoolCakes from '../Components/CoolCakes'
import { FaArrowLeft } from 'react-icons/fa'
import { useNavigate } from 'react-router-dom'

export default function CoolCakesPage() {
  ...
  return (
    ...
    <div className="container-fluid" style={{ backgroundColor: '#f8f9fa', paddingTop: '20px', paddingBottom: '20px' }}>
      <div className="container">
        ...
        {/* <p className="lead text-muted">Refreshing and delightfully cool cake varieties</p> */}
      </div>
    </div>
    <CoolCakes/>
    <Footer/>
